...
#endif
#define ENTEROSPASM_VERSION      0.1
#define ENTEROSPASM_VER_PATCH    0       // helper to print a string like 0.93.2
#ifndef ENTEROSPASM_VER_SUFFIX
#define ENTEROSPASM_VER_SUFFIX           // optional version suffix string literal like "-beta1"
#endif
...
#define	ENTEROSPASM_VER_STRING	QS_STRINGIFY(ENTEROSPASM_VERSION) "." QS_STRINGIFY(ENTEROSPASM_VER_PATCH) ENTEROSPASM_VER_SUFFIX
