...
void M_Menu_Main_f (void);
	...
	// Change by rndtrash: remove multiplayer.
...
void M_Quit_Draw (void) //johnfitz -- modified for new quit message
{
	...
	char	msg2[] = "based on QuakeSpasm" QUAKESPASM_VER_STRING;/* msg2/msg3 are mostly [40] */
	...
	sprintf(msg1, "EnteroSpasm " ENTEROSPASM_VER_STRING);
...
void M_Draw (void)
{
	...
	case m_quit:
		// Change by rndtrash: always ask if quitting.
		/*if (!fitzmode)
